...
first_name, last_name, age = "Reebika", "Bhatta", 21
list_of_tuples.append((first_name, last_name, age))

first_name, last_name, age = "Tanu", "Ayer", None
list_of_tuples.append((first_name, last_name, age))

first_name, last_name, age = "Jaya", "Kc", 22
list_of_tuples.append((first_name, last_name, age))

first_name, last_name, age = "Prajol", "Rai", 23
list_of_tuples.append((first_name, last_name, age))
